    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div class="card">
        <div class="card-header">
          <h2 class="card-title"><i class="fas fa-calculator mr-2 text-cyan-500"></i>Contabilità</h2>
        </div>
      ...
      <div class="card">
        <div class="card-header">
          <h2 class="card-title"><i class="fas fa-chart-line mr-2 text-cyan-500"></i>Finanziario</h2>
        </div>
        <div class="card-content">
          <div class="space-y-2">
